  ...
  <div class="mb-3 text-center">
	  <form>
		  <div class="form-group row">
		    ...
		    <div class="col-sm-6">
		      <input type="text" class="form-control" id="staticEmail" placeholder="아이디를  8~15자이내로 입력하세요.">
		    </div>
		    <div class="col-sm-2">
		      <button type="button" class="btn btn-light">중복체크</button>
		    </div>
		  ...
		  <div class="form-group row">
		    <label for="inputPassword" class="col-sm-2 col-form-label">이메일 인증</label>
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="inputPassword">
		    </div>
		  </div>
